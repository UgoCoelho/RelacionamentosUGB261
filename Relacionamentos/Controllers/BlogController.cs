...
namespace Relacionamentos.Controllers
{
    public class BlogController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("BlogId,Name,SiteUri")] Blog blog)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("BlogId,Name,SiteUri")] Blog blog)
        {
            if (id != blog.BlogId)
            {
                return NotFound();
