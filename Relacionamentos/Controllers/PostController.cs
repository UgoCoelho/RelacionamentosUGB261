...
namespace Relacionamentos.Controllers
{
    public class PostController : Controller
    {
        ...
        {
            var relacionamentosContext = _context.Posts.Include(p => p.Blog);
        ...
        public async Task<IActionResult> Create([Bind("PostId,Title,Content,PublishedOn,Archived,BlogId")] Post post)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("PostId,Title,Content,PublishedOn,Archived,BlogId")] Post post)
        {
            if (id != post.PostId)
            {
                return NotFound();
